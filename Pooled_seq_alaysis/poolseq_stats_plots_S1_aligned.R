...
S1_aligned_dataset_pi_filtered$piRatio <- (S1_aligned_dataset_pi_filtered$piIA/S1_aligned_dataset_pi_filtered$piCP)
...
S1_dxy_plot <- ggplot(S1_aligned_dataset_pi_filtered, aes(x=bp_cum, y= Dxy_win)) +
  geom_point() +
  annotate(geom = "rect", xmin=(119966515+858736), xmax=(119966515+6465310), ymin=-Inf, ymax=Inf,
           color = "#D95F02", 
           fill = "#D95F02", alpha = 0.5, linetype = 2)+
...
S1_depth_plot <- ggplot(S1_aligned_dataset_gstat_filtered, aes(x=bp_cum, y = avg.win.depth)) +
  ...
  annotate(geom = "rect", xmin=(120023242+858736), xmax=(120023242+6465310), ymin=-Inf, ymax=Inf,
           color = "#D95F02", 
           fill = "#D95F02", alpha = 0.5, linetype = 2)+
  annotate(geom = "rect", xmin=(120023242+5998986), xmax=(120023242+6260288), ymin=-Inf, ymax=Inf,
           color = "#1B9E77", 
           fill = "#1B9E77", alpha = 0.5, linetype = 2)+
  annotate(geom = "rect", xmin=(67169025+14125309), xmax=(67169025+18136144), ymin=-Inf, ymax=Inf,
           color = "#7570B3", 
           fill = "#7570B3", alpha = 0.5, linetype = 2)+
  annotate(geom = "rect", xmin=(233485657+5892556), xmax=(233485657+8677481), ymin=-Inf, ymax=Inf,
           color = "#E7298A", 
           fill = "#E7298A", alpha = 0.5, linetype = 2)+
...
S1_alinged_Fig2 <- ggarrange(S1_gstat_plot, S1_pi_plot,S1_depth_plot,nrow = 3, ncol = 1, labels = "AUTO" )

png("./figures/S1_aligned_gouldFig2.png", width = 30, height = 20, units = "cm",res = 300)
print(S1_alinged_Fig2)
dev.off()
## Figure 3 from Gould et al 2017 (G stat values across chromosmes 5, 8, and 14)

S1_dxy_plot_8 <- S1_aligned_dataset_pi_filtered %>% 
  filter(scaff=="8") %>% 
  ...
  annotate(geom = "rect", xmin=(120023242+5998986), xmax=(120023242+6260288), ymin=-Inf, ymax=Inf,
           color = "#1B9E77", 
           fill = "#1B9E77", alpha = 0.5, linetype = 2)+
  ylab(paste("Dxy for chromosome 8"))+
  xlab("")+
  theme_bw()+ theme(panel.border = element_blank(), 
                    panel.grid.major = element_blank(),
                    panel.grid.minor = element_blank(), 
...
S1_gstat_plot_8 <- S1_aligned_dataset_gstat_filtered %>% 
  ...
  geom_point() +
  geom_hline(yintercept =(28.71607), color="black" , linetype = 2) +
  annotate(geom = "rect", xmin=(120023242+858736), xmax=(120023242+6465310), ymin=-Inf, ymax=Inf,
           color = "#D95F02", 
           fill = "#D95F02", alpha = 0.5, linetype = 2)+
  annotate(geom = "rect", xmin=(120023242+5998986), xmax=(120023242+6260288), ymin=-Inf, ymax=Inf,
           color = "#1B9E77", 
           fill = "#1B9E77", alpha = 0.5, linetype = 2)+
 # annotate(geom = "pointrange", x=(121512784), y=37.59390, ymin = 37.59390, ymax = 37.59390,  color= "red",size=.5)+
#  annotate(geom = "pointrange", x=123330348, y=7.696862, ymin = 7.696862, ymax = 7.696862,  color= "blue",size=.5)+
#  annotate(geom = "pointrange", x=123388523, y=5.179836, ymin = 5.179836, ymax = 5.179836,  color= "blue",size=.5)+
#  annotate(geom = "pointrange", x=123455821, y=4.897407, ymin = 4.897407, ymax = 4.897407,  color= "blue",size=.5)+
#  annotate(geom = "pointrange", x=123478826, y=7.391598, ymin = 7.391598, ymax = 7.391598,  color= "blue",size=.5)+
  ylab(paste("G statistic"))+
  xlab("")+
  theme_bw()+ theme(panel.border = element_blank(), 
                    panel.grid.major = element_blank(),
...
S1_alinged_Fig3 <- ggarrange(S1_gstat_plot_5, S1_gstat_plot_8, S1_gstat_plot_14,nrow = 3, ncol = 1 , labels = "AUTO")
...
mean(S1_aligned_dataset_gstat_filtered$G_stat)
...
S1_aligned_dataset_gstat_filtered_no5 <-  S1_aligned_dataset_gstat_filtered %>% 
  filter(scaff!="5")
S1_aligned_dataset_gstat_filtered_no5$karyo <- "notinv"

S1_aligned_dataset_gstat_filtered_5_NotINV_fig <- rbind(S1_aligned_dataset_gstat_filtered_no5,S1_aligned_dataset_gstat_filtered_5_NOTinv2, S1_aligned_dataset_gstat_filtered_5_NOTinv1)

mean(S1_aligned_dataset_gstat_filtered_5_NotINV_fig$G_stat) # Colinear regions of chromosome 5
...
mean(S1_aligned_dataset_gstat_filtered_5_inv$G_stat) # Chromosome 5 inversion
...
S1_aligned_dataset_gstat_filtered_8_NOTinv1 <-  S1_aligned_dataset_gstat_filtered %>% 
  filter(scaff=="8") %>% 
  filter(bp_cum < (120023242+858736)) 
...
S1_aligned_dataset_gstat_filtered_8_NOTinv2 <-  S1_aligned_dataset_gstat_filtered %>% 
  filter(scaff=="8") %>% 
  filter(bp_cum > (120023242+6465310))
S1_aligned_dataset_gstat_filtered_8_NOTinv2$karyo <- "notinv"

S1_aligned_dataset_gstat_filtered_no8 <-  S1_aligned_dataset_gstat_filtered %>% 
  filter(scaff!="8")
S1_aligned_dataset_gstat_filtered_no8$karyo <- "notinv"

S1_aligned_dataset_gstat_filtered_8_NotINV_fig <- rbind(S1_aligned_dataset_gstat_filtered_no8,S1_aligned_dataset_gstat_filtered_8_NOTinv1, S1_aligned_dataset_gstat_filtered_8_NOTinv2)

mean(S1_aligned_dataset_gstat_filtered_8_NotINV_fig$G_stat) # Colinear regions of chromsome 8

S1_aligned_dataset_gstat_filtered_8_inv <-  S1_aligned_dataset_gstat_filtered %>% 
  filter(scaff=="8") %>% 
  filter(between(bp_cum, (120023242+858736),(119966515+6465310)))
S1_aligned_dataset_gstat_filtered_8_inv$karyo <- "inv"

mean(S1_aligned_dataset_gstat_filtered_8_inv$G_stat) #With small chromosome 8

S1_aligned_dataset_gstat_filtered_8_inv_wosmalS1 <-  S1_aligned_dataset_gstat_filtered_8_inv %>% 
  filter(scaff=="8") %>% 
  filter(bp_cum < (120023242+5998986)) 

S1_aligned_dataset_gstat_filtered_8_inv_wosmall2 <-  S1_aligned_dataset_gstat_filtered_8_inv %>% 
  filter(scaff=="8") %>% 
  filter(bp_cum > (120023242+6260288))
...
S1_aligned_dataset_gstat_filtered_8_combined <- rbind(S1_aligned_dataset_gstat_filtered_8_inv_wosmalS1, S1_aligned_dataset_gstat_filtered_8_inv_wosmall2)

mean(S1_aligned_dataset_gstat_filtered_8_combined$G_stat) #Chromsome 8 inversion without the smaller inversion.
...
Gstat_chr8_density <- S1_aligned_dataset_gstat_filtered_8_figure4 %>% 
  ...
  xlab("G-statistic")+
  # ylab("Density")+
  scale_fill_manual(name = "Orientation",labels = c("inversion", "non inverted region"),values = c("#D95F02","#1B9E77"))+
  theme_bw()+ theme(panel.border = element_blank(), 
                    panel.grid.major = element_blank(),
                    panel.grid.minor = element_blank(), 
                    axis.line = element_line(colour = "black"))
...
S1_aligned_dataset_gstat_filtered_8small_NotINV_fig <- rbind(S1_aligned_dataset_gstat_filtered_no8,S1_aligned_dataset_gstat_filtered_no8,S1_aligned_dataset_gstat_filtered_8_NOTinv1, S1_aligned_dataset_gstat_filtered_8_NOTinv2)

S1_aligned_dataset_gstat_filtered_8small_inv <-  S1_aligned_dataset_gstat_filtered %>% 
  filter(scaff=="8") %>% 
  filter(between(bp_cum, (120023242+5998986), (120023242+6260288)))
S1_aligned_dataset_gstat_filtered_8small_inv$karyo <- "inv"

mean(S1_aligned_dataset_gstat_filtered_8small_inv$G_stat) # Small chromosome 8 inversion
...
S1_aligned_dataset_gstat_filtered_14_NOTinv1 <-  S1_aligned_dataset_gstat_filtered %>% 
  filter(scaff=="14") %>% 
  filter(bp_cum < (233738736+5892556)) 
...
S1_aligned_dataset_gstat_filtered_14_NOTinv2 <-  S1_aligned_dataset_gstat_filtered %>% 
  filter(scaff=="14") %>% 
  filter(bp_cum > (233738736+8677481))
S1_aligned_dataset_gstat_filtered_14_NOTinv2$karyo <- "notinv"

S1_aligned_dataset_gstat_filtered_no14 <-  S1_aligned_dataset_gstat_filtered %>% 
  filter(scaff!="14")
S1_aligned_dataset_gstat_filtered_no14$karyo <- "notinv"

S1_aligned_dataset_gstat_filtered_14_NotINV_fig <- rbind(S1_aligned_dataset_gstat_filtered_no14,S1_aligned_dataset_gstat_filtered_14_NOTinv2, S1_aligned_dataset_gstat_filtered_14_NOTinv1)

mean(S1_aligned_dataset_gstat_filtered_14_NotINV_fig$G_stat) # Colinear regions of chromosome 14

S1_aligned_dataset_gstat_filtered_14_inv <-  S1_aligned_dataset_gstat_filtered %>% 
  filter(scaff=="14") %>% 
  filter(between(bp_cum, (233738736+5892556), (233738736+8677481)))
S1_aligned_dataset_gstat_filtered_14_inv$karyo <- "inv"

mean(S1_aligned_dataset_gstat_filtered_14_inv$G_stat) # Chromosome 14 inversion
...
figure4_density_gstat <- ggarrange(Gstat_chr5_density, Gstat_chr8_density, Gstat_chr8small_density, Gstat_chr14_density, nrow = 2, ncol = 4)
...
S1_aligned_dataset_gstat_filtered_8ALL_inv_anova <- rbind(S1_aligned_dataset_gstat_filtered_8small_inv_anova,S1_aligned_dataset_gstat_filtered_8_inv_wosmall_combined,S1_aligned_dataset_gstat_filtered_no8)

S1_aligned_dataset_gstat_filtered_8small_anova <- rbind(S1_aligned_dataset_gstat_filtered_no8,S1_aligned_dataset_gstat_filtered_8ALL_inv_anova, S1_aligned_dataset_gstat_filtered_8_NotINV_fig)

library(car)
summary(aov(G_stat ~ karyo,S1_aligned_dataset_gstat_filtered_8small_anova))
boxplot.8.gstat <- boxplot(G_stat ~ karyo,S1_aligned_dataset_gstat_filtered_8small_anova, names= c("Large Chromosome 8 \n inversion",
                                                                                                   "Small Chromosome 8 \n Inversion", "Chromosome 8 \n not inverted regions" ),
                           col = c("#66A61E", "#E6AB02", "#7570B3"), xaxt ="n", ylab = "G statistic", xlab = "")
axis(side = 1, at = 1:3, labels =  c("Large Chromosome 8 \n inversion",
                                     "Small Chromosome 8 \n Inversion", "Chromosome 8 \n not inverted regions"), tcl = 0)
...
mean(S1_aligned_dataset_nona_tajD_5_inv$TajD_CP)
mean(S1_aligned_dataset_nona_tajD_5_inv$TajD_IA)
...
mean(S1_aligned_dataset_nona_tajD_8_inv$TajD_CP)
mean(S1_aligned_dataset_nona_tajD_8_inv$TajD_IA)
...
S1_aligned_dataset_nona_tajD_8_combined <- rbind(S1_aligned_dataset_nona_tajD_8_inv_wosmalS1, S1_aligned_dataset_nona_tajD_8_inv_wosmall2)
mean(S1_aligned_dataset_nona_tajD_8_combined$TajD_IA)
mean(S1_aligned_dataset_nona_tajD_8_combined$TajD_CP)
...
mean(S1_aligned_dataset_nona_tajD_8small_inv$TajD_CP)
mean(S1_aligned_dataset_nona_tajD_8small_inv$TajD_IA)
############################################################################################################################
...
mean(S1_aligned_dataset_nona_tajD_14_inv$TajD_CP)
mean(S1_aligned_dataset_nona_tajD_14_inv$TajD_IA)
...
png("./figures/tajD_pot_S1.png", width = 15, height = 15, units = "cm",res = 300)
print(tajD_pot_S1)
dev.off()
...
## Distribution of pi window values inside and outside the chromosome inversion

mean(S1_aligned_dataset_pi_filtered$piIA)
mean(S1_aligned_dataset_pi_filtered$piCP)


# Add column for within inversion or not within
S1_aligned_dataset_pi_filtered_5_NOTinv1 <-  S1_aligned_dataset_pi_filtered %>% 
  filter(scaff=="5") %>% 
  filter(bp_cum < 67165139+14125309) 
S1_aligned_dataset_pi_filtered_5_NOTinv1$karyo <- "notinv"

S1_aligned_dataset_pi_filtered_5_NOTinv2 <-  S1_aligned_dataset_pi_filtered %>% 
  filter(scaff=="5") %>% 
  filter(bp_cum > 67165139+18136144)
S1_aligned_dataset_pi_filtered_5_NOTinv2$karyo <- "notinv"

S1_aligned_dataset_pi_filtered_no5 <-  S1_aligned_dataset_pi_filtered %>% 
  filter(scaff!="5")
S1_aligned_dataset_pi_filtered_no5$karyo <- "notinv"

S1_aligned_dataset_pi_filtered_5_NotINV_fig <- rbind(S1_aligned_dataset_pi_filtered_no5,S1_aligned_dataset_pi_filtered_5_NOTinv2, S1_aligned_dataset_pi_filtered_5_NOTinv1)

# Colinear regions on chromosome 5
mean(S1_aligned_dataset_pi_filtered_5_NotINV_fig$piIA)
mean(S1_aligned_dataset_pi_filtered_5_NotINV_fig$piCP)
mean(S1_aligned_dataset_pi_filtered_5_NotINV_fig$piIA)/mean(S1_aligned_dataset_pi_filtered_5_NotINV_fig$piCP)

S1_aligned_dataset_pi_filtered_5_inv <-  S1_aligned_dataset_pi_filtered %>% 
  filter(scaff=="5") %>% 
  filter(between(bp_cum, (67165139+14125309),(67165139+18136144) ))
S1_aligned_dataset_pi_filtered_5_inv$karyo <- "inv"

# Chromosome 5 inversion
mean(S1_aligned_dataset_pi_filtered_5_inv$piRatio)
mean(S1_aligned_dataset_pi_filtered_5_inv$piCP)
mean(S1_aligned_dataset_pi_filtered_5_inv$piIA)

S1_aligned_dataset_pi_filtered_5_figure4 <- rbind(S1_aligned_dataset_pi_filtered_5_inv, S1_aligned_dataset_pi_filtered_5_NotINV_fig)

pi_chr5_density <- S1_aligned_dataset_pi_filtered_5_figure4 %>% 
...
S1_aligned_dataset_pi_filtered_8_NOTinv1 <-  S1_aligned_dataset_pi_filtered %>% 
  filter(scaff=="8") %>% 
  filter(bp_cum < (119966515+858736)) 

S1_aligned_dataset_pi_filtered_8_NOTinv1$karyo <- "notinv"

S1_aligned_dataset_pi_filtered_8_NOTinv2 <-  S1_aligned_dataset_pi_filtered %>% 
  filter(scaff=="8") %>% 
  filter(bp_cum > (119966515+6465310))
S1_aligned_dataset_pi_filtered_8_NOTinv2$karyo <- "notinv"

S1_aligned_dataset_pi_filtered_no8 <-  S1_aligned_dataset_pi_filtered %>% 
  filter(scaff!="8")
S1_aligned_dataset_pi_filtered_no8$karyo <- "notinv"

S1_aligned_dataset_pi_filtered_8_NotINV_fig <- rbind(S1_aligned_dataset_pi_filtered_no8,S1_aligned_dataset_pi_filtered_8_NOTinv1, S1_aligned_dataset_pi_filtered_8_NOTinv2)

# Colinear regions of chromosome 8
mean(S1_aligned_dataset_pi_filtered_8_NotINV_fig$piRatio)
mean(S1_aligned_dataset_pi_filtered_8_NotINV_fig$piIA)
mean(S1_aligned_dataset_pi_filtered_8_NotINV_fig$piCP)
mean(S1_aligned_dataset_pi_filtered_8_NotINV_fig$Dxy_win)

S1_aligned_dataset_pi_filtered_8_inv <-  S1_aligned_dataset_pi_filtered %>% 
  filter(scaff=="8") %>% 
  filter(between(bp_cum, (119966515+858736),(119966515+6465310)))
S1_aligned_dataset_pi_filtered_8_inv$karyo <- "inv"

# Chromosome 8 inversion
mean(S1_aligned_dataset_pi_filtered_8_inv$piRatio)
mean(S1_aligned_dataset_pi_filtered_8_inv$piIA)
mean(S1_aligned_dataset_pi_filtered_8_inv$piCP)

mean(S1_aligned_dataset_pi_filtered_8_inv$Dxy_win)

S1_aligned_dataset_pi_filtered_8_inv_wosmalS1 <-  S1_aligned_dataset_pi_filtered_8_inv %>% 
  filter(scaff=="8") %>% 
  filter(bp_cum < (119966515+5998986)) 

S1_aligned_dataset_pi_filtered_8_inv_wosmall2 <-  S1_aligned_dataset_pi_filtered_8_inv %>% 
  filter(scaff=="8") %>% 
  filter(bp_cum > (119966515+6260288))

S1_aligned_dataset_pi_filtered_8_inv_wosmall_combined <- rbind(S1_aligned_dataset_pi_filtered_8_inv_wosmalS1, S1_aligned_dataset_pi_filtered_8_inv_wosmall2)

# Chromosome 8 inversion without the small inversion
mean(S1_aligned_dataset_pi_filtered_8_inv_wosmall_combined$piRatio)
mean(S1_aligned_dataset_pi_filtered_8_inv_wosmall_combined$piIA)
mean(S1_aligned_dataset_pi_filtered_8_inv_wosmall_combined$piCP)

mean(S1_aligned_dataset_pi_filtered_8_inv_wosmall_combined$Dxy_win)

S1_aligned_dataset_pi_filtered_8_figure4 <- rbind(S1_aligned_dataset_pi_filtered_8_inv_wosmalS1, S1_aligned_dataset_pi_filtered_8_inv_wosmall2, S1_aligned_dataset_pi_filtered_8_NotINV_fig)


pi_chr8_density <- S1_aligned_dataset_pi_filtered_8_figure4 %>% 
  ggplot(aes(x=piRatio, fill=karyo)) +
  geom_density(alpha=.3)+
  xlab("\u03c0 Ratio")+
  ggtitle("inv_chr8A")+
...
S1_aligned_dataset_pi_filtered_8small_NOTinv1 <-  S1_aligned_dataset_pi_filtered %>% 
  filter(scaff=="8") %>% 
  filter(bp_cum < (119966515+5998986)) 

S1_aligned_dataset_pi_filtered_8small_NOTinv1$karyo <- "notinv"

S1_aligned_dataset_pi_filtered_8small_NOTinv2 <-  S1_aligned_dataset_pi_filtered %>% 
  filter(scaff=="8") %>% 
  filter(bp_cum > (119966515+6260288))
S1_aligned_dataset_pi_filtered_8small_NOTinv2$karyo <- "notinv"

S1_aligned_dataset_pi_filtered_8small_NotINV_fig <- rbind(S1_aligned_dataset_pi_filtered_8_NOTinv1, S1_aligned_dataset_pi_filtered_8_NOTinv2)

S1_aligned_dataset_pi_filtered_8small_inv <-  S1_aligned_dataset_pi_filtered %>% 
  filter(scaff=="8") %>% 
  filter(between(bp_cum, (119966515+5998986), (119966515+6260288)))
S1_aligned_dataset_pi_filtered_8small_inv$karyo <- "inv"

# Chromosome 8 small inversion
mean(S1_aligned_dataset_pi_filtered_8small_inv$piRatio)
mean(S1_aligned_dataset_pi_filtered_8small_inv$piIA)
mean(S1_aligned_dataset_pi_filtered_8small_inv$piCP)

mean(S1_aligned_dataset_pi_filtered_8small_inv$Dxy_win)

S1_aligned_dataset_pi_filtered_8small_figure4 <- rbind(S1_aligned_dataset_pi_filtered_8small_inv, S1_aligned_dataset_pi_filtered_8small_NotINV_fig)

pi_chr8small_density <- S1_aligned_dataset_pi_filtered_8small_figure4 %>% 
  ggplot(aes(x=piRatio, fill=karyo)) +
  geom_density(alpha=.3)+
  xlab("\u03c0 Ratio")+
  ggtitle("inv_chr8B")+
...
S1_aligned_dataset_pi_filtered_14_NOTinv1 <-  S1_aligned_dataset_pi_filtered %>% 
  filter(scaff=="14") %>% 
  filter(bp_cum < (233738736+5892556)) 

S1_aligned_dataset_pi_filtered_14_NOTinv1$karyo <- "notinv"

S1_aligned_dataset_pi_filtered_14_NOTinv2 <-  S1_aligned_dataset_pi_filtered %>% 
  filter(scaff=="14") %>% 
  filter(bp_cum > (233738736+8677481))
S1_aligned_dataset_pi_filtered_14_NOTinv2$karyo <- "notinv"

S1_aligned_dataset_pi_filtered_no14 <-  S1_aligned_dataset_pi_filtered %>% 
  filter(scaff!="14")

S1_aligned_dataset_pi_filtered_no14$karyo <- "notinv"

S1_aligned_dataset_pi_filtered_14_NotINV_fig <- rbind(
  S1_aligned_dataset_pi_filtered_no14,S1_aligned_dataset_pi_filtered_14_NOTinv2, S1_aligned_dataset_pi_filtered_14_NOTinv1)

#Colinear regions of chromosome 14
mean(S1_aligned_dataset_pi_filtered_14_NotINV_fig$piRatio)
mean(S1_aligned_dataset_pi_filtered_14_NotINV_fig$piIA)
mean(S1_aligned_dataset_pi_filtered_14_NotINV_fig$piCP)

S1_aligned_dataset_pi_filtered_14_inv <-  S1_aligned_dataset_pi_filtered %>% 
  filter(scaff=="14") %>% 
  filter(between(bp_cum, (233738736+5892556), (233738736+8677481)))
S1_aligned_dataset_pi_filtered_14_inv$karyo <- "inv"

#Chromosome 14 inversion
mean(S1_aligned_dataset_pi_filtered_14_inv$piRatio)
mean(S1_aligned_dataset_pi_filtered_14_inv$piCP)
mean(S1_aligned_dataset_pi_filtered_14_inv$piIA)
mean(S1_aligned_dataset_pi_filtered_14_inv$piIA)/mean(S1_aligned_dataset_pi_filtered_14_inv$piCP)

S1_aligned_dataset_pi_filtered_14_figure4 <- rbind(S1_aligned_dataset_pi_filtered_14_inv, S1_aligned_dataset_pi_filtered_14_NotINV_fig)

pi_chr14_density <- S1_aligned_dataset_pi_filtered_14_figure4 %>% 
  ggplot(aes(x=piRatio, fill=karyo)) +
  geom_density(alpha=.3)+
  xlab("\u03c0 Ratio")+
  ggtitle("inv_chr14A")+
...
tiff("./figures/figure4_density_pi.png", width = 20, height = 30, units = "cm",res = 300)
...
jpeg("./figures/S1_aligned_inversion_stat_figure.jpg", width = 28, height = 20, units = "cm",res = 400)
