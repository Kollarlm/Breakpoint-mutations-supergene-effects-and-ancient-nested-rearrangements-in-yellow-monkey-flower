...
gids <- c("SWB","LMC") #Whatever you list FIRST here will be the reference genome in the pan-genome function.
...
# Ran orthofinde on MSU's HPCC but it works better if you run it on your local computer
...
jpeg(filename = "S1_L1_plot.jpeg",height = 6, width = 12, units="cm",
     res = 400)
